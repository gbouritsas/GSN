...
for i in range(10):
    ...
    args = [
        ...
        '--k', '6',
        '--id_scope', 'local',
        '--id_encoding', 'one_hot_unique',
        '--id_embedding', 'embedding',
        '--input_node_encoder', 'atom_encoder',
        '--edge_encoder', 'bond_encoder',
        '--input_vn_encoder', 'embedding',
        '--model_name', 'GSN_edge_sparse_ogb',
        '--msg_kind', 'ogb',
        '--num_layers', '5',
        '--d_out', '300',
        '--d_h', '600',
        ...
        '--wandb', 'False',
        '--wandb', 'True',
        '--wandb_project', 'substructures-ogbg-molhiv_final',
        '--wandb_entity', 'isopepper',
        '--return_scores']
...
print('---')
print('best test')
best_tests = [scores['best_test_mean'] for scores in scores_list]
print('{} ± {}'.format(torch.mean(torch.FloatTensor(best_tests)), torch.std(torch.FloatTensor(best_tests))))
print('---')
print('last test')
